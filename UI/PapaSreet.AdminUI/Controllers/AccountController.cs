...
namespace PapaSreet.AdminUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(/*ApplicationUserManager userManager, ApplicationSignInManager signInManager, */UserServiceFacade userServiceFacade)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                UserDao user = new UserDao { UserName = model.Email, Email = model.Email};
